from infra.service.alpaca.convert_to_query import convert_body_to_query_alpaca_bar


def test_convert_body_to_query_alpaca_bar():
    mock_body_bar = {
        "bars": [
            {
            "c": 178.21,
    ...
    assert expect_query == convert_body_to_query_alpaca_bar(mock_body_bar, '1Min')

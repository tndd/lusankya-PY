from infra.service.alpaca.convert import body_to_query_alpaca_bar


def test_body_to_query_alpaca_bar():
    mock_body_bar = {
        "bars": [
            {
            "c": 178.21,
    ...
    assert expect_query == body_to_query_alpaca_bar(mock_body_bar, '1Min')
